...
$settings = array(
				...
				'homepage_aCancer_posts_heading' => '',
				'homepage_posts_layout' => 'layout-full'
				);

$settings = woo_get_dynamic_values( $settings );

if ( 0 < intval( $settings['homepage_aCancer_id'] ) ) {
$query = new WP_Query( array( 'page_id' => $settings['homepage_aCancer_id'] ) );
?>

<div id="aCancer" class="widget_woo_component">
	<div class="col-full <?php echo esc_attr( $settings['homepage_posts_layout'] ); ?>">
		<span class="heading"><?php echo $settings['homepage_aCancer_posts_heading']; ?><!--About male cancer--></span>
