...
$settings = array(
				'homepage_partners_id' => '',
				'thumb_single' => 'false',
				'single_w' => 200,
				'single_h' => 200,
				'thumb_single_align' => 'alignleft',
				'homepage_partners_posts_heading' => '',
				'homepage_posts_layout' => 'layout-full'
				);

$settings = woo_get_dynamic_values( $settings );

if ( 0 < intval( $settings['homepage_partners_id'] ) ) {
$query = new WP_Query( array( 'page_id' => $settings['homepage_partners_id'] ) );
?>

<div id="partners" class="widget_woo_component">
	<div class="col-full <?php echo esc_attr( $settings['homepage_posts_layout'] ); ?>">
		<span class="heading"><?php echo $settings['homepage_partners_posts_heading']; ?><!--Partners--></span>
