...
$settings = array(
				...
				'homepage_donate_posts_heading' => '',
				'homepage_posts_layout' => 'layout-full'
				);

$settings = woo_get_dynamic_values( $settings );

if ( 0 < intval( $settings['homepage_donate_id'] ) ) {
$query = new WP_Query( array( 'page_id' => $settings['homepage_donate_id'] ) );
?>

<div id="donate" class="widget_woo_component">
	<div class="col-full <?php echo esc_attr( $settings['homepage_posts_layout'] ); ?>">
		<span class="heading"><?php echo $settings['homepage_donate_posts_heading']; ?><!--Donate--></span>
