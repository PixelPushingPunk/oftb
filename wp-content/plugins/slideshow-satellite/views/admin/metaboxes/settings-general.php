...
<!--                <tr>
    ...
    <table class="form-table">
                    <tr>
                    <th><label for="abscenter"><?php _e('Fit and Center', SATL_PLUGIN_NAME); ?></label></th>
                    <td>
                            ...
                            <span class="howto"><?php _e('This will fit the image within the frame and center horizontally and/or vertically', SATL_PLUGIN_NAME); ?></span>
                    </td>
            </tr>
    </table>